            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-slate-500">
                        {isAdmin ? "Track facility-wide equipment issues" : "Report and track your equipment issues"}
                    </p>
                </div>
                        ...
                        {tickets?.length === 0 ? (
                            <TableRow>
                                <TableCell colSpan={isAdmin ? 7 : 6} className="text-center py-12 text-slate-600 font-medium">
                                    {isAdmin ? "No maintenance tickets found." : "You haven't reported any maintenance issues yet."}
                                </TableCell>
                            </TableRow>
                        ) : (
                            tickets?.map((ticket) => (
