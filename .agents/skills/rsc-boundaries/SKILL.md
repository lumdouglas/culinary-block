...
name: rsc-boundaries
description: >
  Detect and fix invalid React Server Component / Client Component boundary
  patterns. Use when: a component uses 'use client' and async, non-serializable
  props are passed from server to client, or there is a Server/Client boundary
  error. Triggers on: "use client", "async component", "server component",
  "cannot serialize", "RSC", "boundary error".
---
